...
c1 = Cuisine.create(region: "Africa", image: "http://placehold.it/300")
  Recipe.create(name: "Egyptian Koshari", image: "http://placehold.it/300", ingredients: "a", instructions: "a", cuisine_id: c1.id)
  Recipe.create(name: "Sambusa", image: "http://placehold.it/300", ingredients: "a", instructions: "a", cuisine_id: c1.id)
  Recipe.create(name: "Moroccan Tangine", image: "http://placehold.it/300", ingredients: "a", instructions: "a", cuisine_id: c1.id)
  Recipe.create(name: "Algerian Kefte", image: "http://placehold.it/300", ingredients: "a", instructions: "a", cuisine_id: c1.id)
  Recipe.create(name: "Chakchouka", image: "http://placehold.it/300", ingredients: "a", instructions: "a", cuisine_id: c1.id)

c2 = Cuisine.create(region: "Asia", image: "http://placehold.it/300")
  Recipe.create(name: "Japanese Udon", image: "http://placehold.it/300", ingredients: "a", instructions: "a", cuisine_id: c2.id)
  Recipe.create(name: "Thai Green Curry", image: "http://placehold.it/300", ingredients: "a", instructions: "a", cuisine_id: c2.id)
  Recipe.create(name: "Korean Bi Bim Bap", image: "http://placehold.it/300", ingredients: "a", instructions: "a", cuisine_id: c2.id)
  Recipe.create(name: "Chicken Makhni", image: "http://placehold.it/300", ingredients: "a", instructions: "a", cuisine_id: c2.id)
  Recipe.create(name: "Vietnamese Rolls", image: "http://placehold.it/300", ingredients: "a", instructions: "a", cuisine_id: c2.id)
